        ...
        if (System.currentTimeMillis() > wait_timeout) {
            ...
            switch (TheFlowOfTheHorror.getStage()) {
                case 1:
                    ...
                    addMoveToDesire(points_stage1[index], true, 5);
                    doTask();
                    return true;
                case 2:
                    switch (step_stage2) {
                        case 1:
                            ...
                            addMoveToDesire(points_stage2[0], true, 5);
                            doTask();
                            step_stage2 = 2;
                            return true;
                        case 2:
    ...
    protected boolean createNewTask() {
        ...
        for (NpcInstance npc : World.getAroundNpc(actor, 1000, 200))
            if (Rnd.chance(10) && npc != null && npc.getNpcId() == 20235) {
                ...
                if (Rnd.chance(20))
                    addUseSkillDesire(monster, actor.getKnownSkill(1467), 10000);
                else
                    addAttackDesire(monster, 1, 10000);
                return true;
            }
        return true;
    }
