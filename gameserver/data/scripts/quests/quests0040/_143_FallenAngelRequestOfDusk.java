...
public class _143_FallenAngelRequestOfDusk extends Quest implements ScriptFile {
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("start")) {
            ...
            st.setState(STARTED);
            st.unset("talk");
            st.doTakeItems(EMPTY_CRYSTAL, -1);
            st.doGiveItems(MESSAGE, 1);
            st.playSound(SOUND_MIDDLE);
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == NATOOLS) {
            ...
            if (cond == 2)
                ...
                st.doRewardItems(ADENA_ID, 89046);
                st.addExpAndSp(RATE_QUESTS_REWARD * 223036, RATE_QUESTS_REWARD * 13901);
