...
import quests.quests4060._021_HiddenTruth;
...
public class _022_TragedyInVonHellmannForest extends Quest implements ScriptFile {
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("31334-03.htm")) {
            ...
            st.setCond(8);
            st.doGiveItems(LetterOfInnocentin, 1);
        } else if (event.equalsIgnoreCase("31529-09.htm")) {
            st.setCond(9);
            st.doTakeItems(LetterOfInnocentin, 1);
        } else if (event.equalsIgnoreCase("explore")) {
            despawnSoulOfWell();
            spawnSoulOfWell(st);
            st.setCond(10);
            st.doGiveItems(JewelOfAdventurerGreen, 1);
            ...
            despawnSoulOfWell();
            st.doGiveItems(JewelOfAdventurerRed, 1);
            st.doTakeItems(JewelOfAdventurerGreen, -1);
            st.setCond(11);
        } else if (event.equalsIgnoreCase("31328-08.htm")) {
            st.startQuestTimer("wait_timer", 600000);
            st.setCond(15);
            st.doTakeItems(ReportBox, 1);
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == Tifaren) {
            ...
            if (cond == 7)
                ...
                htmltext = "31328-17.htm";
                st.addExpAndSp(RATE_QUESTS_REWARD * 345966, RATE_QUESTS_REWARD * 31578);
            ...
            if (cond == 8) {
                ...
                if (st.getQuestItemsCount(JewelOfAdventurerRed) != 0) {
                    ...
                    st.doTakeItems(JewelOfAdventurerRed, 1);
                    st.setCond(12);
                } else {
                    st.setCond(9);
                    htmltext = "31529-09.htm";
                ...
                if (st.getQuestItemsCount(SealedReportBox) != 0) {
                    ...
                    st.setCond(14);
                    st.doTakeItems(SealedReportBox, 1);
                    st.doGiveItems(ReportBox, 1);
                } else {
                    st.setCond(12);
                    htmltext = "31529-10.htm";
                }
            ...
            if (cond == 9)
                ...
                st.setCond(13);
                st.doGiveItems(SealedReportBox, 1);
            }
        return htmltext;
    }
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        ...
        if (Mobs.contains(npcId)) {
            if (cond == 4 && st.doGiveOnKillItems(LostSkullOfElf, 1, 1, 1, 99)) {
                st.setCond(5);
            }
        }
        if (npcId == SoulOfWell) {
