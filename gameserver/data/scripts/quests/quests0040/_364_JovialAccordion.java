    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == BARBADO) {
            if (cond == 0)
                ...
                st.doGiveItems(ECHO, 1);
                st.doGiveItems(57, 100);
