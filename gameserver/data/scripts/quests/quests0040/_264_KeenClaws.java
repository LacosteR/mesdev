        ...
        if (npcId == Payne)
            if (cond == 0) {
                ...
                if (n == 0) {
                    ...
                    st.doGiveItems(LeatherSandals, 1);
                else if (n < 8) {
                    st.doGiveItems(Stockings, 1);
                    st.doGiveItems(ADENA_ID, RATE_QUESTS_REWARD * 50);
                } else if (n < 11)
                    st.doGiveItems(HealingPotion, 1);
                else if (n < 14)
                    st.doGiveItems(ShortGloves, 1);
                else
                    st.doGiveItems(ClothShoes, 1);
