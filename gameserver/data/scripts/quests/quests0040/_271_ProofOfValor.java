    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == RUKAIN)
            if (cond == 0) {
                ...
                st.doTakeItems(KASHA_WOLF_FANG_ID, -1);
                if (Rnd.chance(14)) {
                    st.doTakeItems(NECKLACE_OF_VALOR_ID, -1);
                    st.doGiveItems(NECKLACE_OF_VALOR_ID, 1);
                } else {
                    st.doTakeItems(NECKLACE_OF_COURAGE_ID, -1);
                    st.doGiveItems(NECKLACE_OF_COURAGE_ID, 1);
                }
