...
public class _160_NerupasFavor extends Quest implements ScriptFile {
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equals("30370-04.htm")) {
            ...
            st.doGiveItems(SILVERY_SPIDERSILK, 1);
        }
        return htmltext;
    }
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == NERUPA) {
            if (st.getState() == CREATED) {
                ...
                st.doTakeItems(NIGHTSHADE_LEAF, -1);
            ...
            if (cond == COND1) {
                st.doTakeItems(SILVERY_SPIDERSILK, -1);
                st.doGiveItems(UNOS_RECEIPT, 1);
                st.setCond(COND2);
            ...
            if (cond == COND2) {
                st.doTakeItems(UNOS_RECEIPT, -1);
                st.doGiveItems(CELS_TICKET, 1);
                st.setCond(COND3);
            ...
            if (cond == COND3) {
                st.doTakeItems(CELS_TICKET, -1);
                st.doGiveItems(NIGHTSHADE_LEAF, 1);
