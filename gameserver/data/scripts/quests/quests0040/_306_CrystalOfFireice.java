...
public class _306_CrystalOfFireice extends Quest implements ScriptFile {
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (_state == CREATED) {
            ...
            if (Reward > 0) {
                ...
                st.doTakeItems(Flame_Shard, -1);
                st.doTakeItems(Ice_Shard, -1);
    ...
    public String onKill(NpcInstance npc, QuestState qs) {
        ...
        if ((npcId == Salamander_Noble || npcId == Undine_Noble) && !Rnd.chance(Noble_Chance))
            return null;
        qs.doGiveItems(npcId == Salamander || npcId == Salamander_Elder || npcId == Salamander_Noble ? Flame_Shard : Ice_Shard, 1);
