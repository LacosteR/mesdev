...
public class _406_PathToElvenKnight extends Quest implements ScriptFile {
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("master_sorius_q0406_05.htm")) {
            ...
            } else if (st.getPlayer().getPcClass().class_id == 0x13) {
            ...
            st.doTakeItems(SoriussLetter, -1);
            st.doGiveItems(KlutosMemo, 1);
            st.setCond(4);
            st.setState(STARTED);
        } else
            htmltext = "noquest";
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == Sorius) {
            if (cond == 0)
                ...
                st.doTakeItems(TopazPiece, -1);
                st.doGiveItems(SoriussLetter, 1);
                ...
                st.doTakeItems(KlutoBox, -1);
                if (st.getPlayer().getPcClass().getLevel() == 1) {
                    st.doGiveItems(ElvenKnightBrooch, 1);
            ...
            if (cond == 3)
                ...
                st.doTakeItems(EmeraldPiece, -1);
                st.doTakeItems(KlutosMemo, -1);
                st.doGiveItems(KlutoBox, 1);
