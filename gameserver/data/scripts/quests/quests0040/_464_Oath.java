...
public class _464_Oath extends Quest implements ScriptFile {
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("bookowner")) {
            ...
            st.doTakeItems(BookofSilence1);
            st.doGiveItems(BookofSilence2, 1);
            ...
            st.doRewardItems(ADENA_ID, Rnd.get(42910, 210806));
            st.addExpAndSp(RATE_QUESTS_REWARD * Rnd.get(15449, 249180), RATE_QUESTS_REWARD * Rnd.get(17696, 58551));
            st.doTakeItems(BookofSilence2);
