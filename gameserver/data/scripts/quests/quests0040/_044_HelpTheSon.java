...
public class _044_HelpTheSon extends Quest implements ScriptFile {
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        ...
        if (st.doGiveOnKillItems(GEMSTONE_FRAGMENT, 1, 1, 30, 100))
            st.setCond(3);
