...
public class _634_InSearchofDimensionalFragments extends Quest implements ScriptFile {
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        st.doGiveOnKillItems(DIMENSION_FRAGMENT_ID, 1, 1, 60 * Experience.penaltyModifier(st.calculateLevelDiffForDrop(npc.getLevel(), st.getPlayer().getLevel()), 9) * npc.getTemplate().rateHp / 4);
        return null;
    }
}