...
public class _380_BringOutTheFlavorOfIngredients extends Quest implements ScriptFile {
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        if (event.equalsIgnoreCase("rollant_q0380_05.htm")) {
            ...
            st.doGiveItems(RitronsDessertRecipe, 1);
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == Rollant) {
            if (cond == 0) {
                ...
                st.doTakeItems(Antidote, 2);
                st.doTakeItems(RitronsFruit, -1);
                st.doTakeItems(MoonFaceFlower, -1);
                st.doTakeItems(LeechFluids, -1);
