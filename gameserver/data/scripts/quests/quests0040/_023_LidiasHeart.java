...
public class _023_LidiasHeart extends Quest implements ScriptFile {
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equals("31328-02.htm")) {
            st.doGiveItems(MapForestofDeadman, 1);
            st.doGiveItems(SilverKey, 1);
            st.setCond(1);
            st.setState(STARTED);
            ...
            st.setCond(10);
            st.doTakeItems(SilverKey, -1);
            st.doGiveItems(SilverSpear, 1);
        ...
        if (npcId == Innocentin) {
            ...
            if (cond == 8) {
                ...
                if (st.getQuestItemsCount(SilverSpear) != 0) {
                    ...
                    st.doTakeItems(SilverSpear, -1);
                    st.doRewardItems(ADENA_ID, 350000);
                    st.addExpAndSp(RATE_QUESTS_REWARD * 456893, RATE_QUESTS_REWARD * 42112);
