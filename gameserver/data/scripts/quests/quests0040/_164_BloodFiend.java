    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == Creamees)
            if (cond == 0) {
                ...
                st.doTakeItems(KirunakSkull, -1);
                st.doRewardItems(ADENA_ID, 42130);
                st.addExpAndSp(RATE_QUESTS_REWARD * 35637, RATE_QUESTS_REWARD * 1854);
