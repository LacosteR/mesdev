    ...
    public String onKill(NpcInstance npc, QuestState qs) {
        ...
        if (party == null) {
            ...
            for (Player m : party.getPartyMembers())
                if (m != player && PositionUtils.isInRange(m, npc.getPositionComponent().getLoc(), ConfigOthers.PARTY_DISTRIBUTION_RANGE, false))
