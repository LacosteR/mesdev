    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("quest_accept") && _state == CREATED) {
            ...
            if (cond == 2 && st.getQuestItemsCount(Musical_Score__Theme_of_the_Feast) > 0) {
                ...
                st.doTakeItems(Musical_Score__Theme_of_the_Feast, 1);
                st.setCond(3);
            } else
            ...
            if (cond == 3 && st.getQuestItemsCount(Jonass_Salad_Recipe) > 0) {
                ...
                st.doTakeItems(Jonass_Salad_Recipe, 1);
                st.setCond(4);
            ...
            if (cond == 3 && st.getQuestItemsCount(Jonass_Sauce_Recipe) > 0) {
                ...
                st.doTakeItems(Jonass_Sauce_Recipe, 1);
                st.setCond(4);
            ...
            if (cond == 3 && st.getQuestItemsCount(Jonass_Steak_Recipe) > 0) {
                ...
                st.doTakeItems(Jonass_Steak_Recipe, 1);
                st.setCond(4);
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (_state == CREATED) {
            ...
            if (st.getQuestItemsCount(Ritrons_Dessert_Recipe) > 0 && reward != null) {
                ...
                st.doTakeItems(Ritrons_Dessert_Recipe, 1);
                st.doGiveItems(reward[0], RATE_QUESTS_REWARD * reward[1]);
                if (reward[2] > 0)
                    st.doGiveItems(ADENA_ID, RATE_QUESTS_REWARD * reward[2]);
