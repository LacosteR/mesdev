    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == Silvera) {
            if (st.getQuestItemsCount(FinalPassCertificate) != 0) {
                ...
                if (st.getPlayer().getPcClass().class_id != 0x35) {
                ...
                st.doTakeItems(BoogleRatmanTooth, -1);
                st.doTakeItems(BoogleRatmanLeadersTooth, -1);
                st.doTakeItems(SilverasRing, -1);
                st.doGiveItems(PassCertificate1st, 1);
