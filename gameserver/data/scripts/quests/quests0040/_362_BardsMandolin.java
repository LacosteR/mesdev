...
public class _362_BardsMandolin extends Quest implements ScriptFile {
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == SWAN) {
            ...
            st.doTakeItems(SWANS_FLUTE, 1);
            st.doTakeItems(SWANS_LETTER, 1);
            st.setCond(5);
        }
        return htmltext;
    }
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("30957_2.htm") && _state == CREATED && cond == 0) {
            ...
            st.doGiveItems(Musical_Score__Theme_of_Journey, 1);
