    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("30531-04.htm")) {
            if (!st.getPlayer().getVarB("dd3")) {
                st.doGiveItems(DD, RATE_QUESTS_REWARD * 23);
            ...
            st.doGiveItems(PaintOfKamuru, 1);
            st.setCond(3);
            st.setState(STARTED);
        } else if (event.equalsIgnoreCase("30556-05.htm")) {
            st.doTakeItems(PaintOfTeleportDevice, -1);
            st.doGiveItems(BrokenTeleportDevice, 1);
            st.setCond(9);
            st.setState(STARTED);
            st.getPlayer().teleToLocation(140352, -194133, -2028);
        } else if (event.equalsIgnoreCase("30673-04.htm")) {
            st.doTakeItems(BloodOfLeech, -1);
            st.doTakeItems(StingerWaspNeedle, -1);
            st.doTakeItems(MarshSpidersWeb, -1);
            st.doTakeItems(IngredientsOfAntidote, -1);
            st.doGiveItems(ReportOfCruma, 1);
            st.setCond(15);
            st.setState(STARTED);
        }
        return htmltext;
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == Lockirin) {
            if (st.getQuestItemsCount(MarkOfMaestro) != 0) {
                ...
                st.doTakeItems(RecommendationOfBalanki, -1);
                st.doTakeItems(RecommendationOfFilaur, -1);
                st.doTakeItems(RecommendationOfArin, -1);
                st.doGiveItems(MarkOfMaestro, 1);
            ...
            if ((cond == 1 || cond == 11 || cond == 16) && st.getQuestItemsCount(RecommendationOfBalanki) == 0)
                ...
                st.doTakeItems(LetterOfSolderDetachment, -1);
                st.doGiveItems(RecommendationOfBalanki, 1);
            ...
            if ((cond == 1 || cond == 7 || cond == 16) && st.getQuestItemsCount(RecommendationOfArin) == 0) {
                st.doGiveItems(PaintOfTeleportDevice, 1);
                ...
                st.doTakeItems(TeleportDevice, -1);
                st.doGiveItems(RecommendationOfArin, 1);
            ...
            if ((cond == 1 || cond == 7 || cond == 11) && st.getQuestItemsCount(RecommendationOfFilaur) == 0) {
                st.doGiveItems(ArchitectureOfCruma, 1);
                ...
                st.doTakeItems(ReportOfCruma, 1);
                st.doGiveItems(RecommendationOfFilaur, 1);
                st.setCond(16);
            ...
            if (cond == 2)
                ...
                st.doTakeItems(NecklaceOfKamuru, -1);
                st.doTakeItems(PaintOfKamuru, -1);
                st.doGiveItems(LetterOfSolderDetachment, 1);
            ...
            if (cond == 8)
                ...
                st.doTakeItems(BrokenTeleportDevice, -1);
                st.doGiveItems(TeleportDevice, 5);
            ...
            if (cond == 12) {
                st.doTakeItems(ArchitectureOfCruma, -1);
                st.doGiveItems(IngredientsOfAntidote, 1);
                st.setCond(13);
