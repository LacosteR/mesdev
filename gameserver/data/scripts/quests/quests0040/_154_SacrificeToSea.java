...
public class _154_SacrificeToSea extends Quest implements ScriptFile {
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == 30312 && st.getCond() == 0) {
            ...
            st.doGiveItems(FOX_FUR_YARN_ID, 1);
            st.doTakeItems(FOX_FUR_ID, st.getQuestItemsCount(FOX_FUR_ID));
            ...
            st.doGiveItems(MAIDEN_DOLL_ID, 1);
            st.doTakeItems(FOX_FUR_YARN_ID, st.getQuestItemsCount(FOX_FUR_YARN_ID));
            ...
            if (st.getInt("id") != 154) {
                ...
                st.doTakeItems(MAIDEN_DOLL_ID, st.getQuestItemsCount(MAIDEN_DOLL_ID));
                st.doGiveItems(MYSTICS_EARRING_ID, 1);
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        ...
        st.doGiveOnKillItems(FOX_FUR_ID, 1, 1, 10, 14);
