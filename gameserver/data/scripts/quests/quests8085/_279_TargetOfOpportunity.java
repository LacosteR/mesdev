...
public class _279_TargetOfOpportunity extends Quest implements ScriptFile {
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("jerian_q279_04.htm")) {
            ...
            st.doTakeItems(SealComponentsPart1, -1);
            st.doTakeItems(SealComponentsPart2, -1);
            st.doTakeItems(SealComponentsPart3, -1);
            st.doTakeItems(SealComponentsPart4, -1);
            st.doGiveItems(15515, 1);
            st.doGiveItems(15516, 1);
