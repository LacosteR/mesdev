...
import quests.quests7680._198_SevenSignsEmbryo;
...
public class _10292_SevenSignsGirlOfDoubt extends Quest implements ScriptFile {
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("priest_wood_q10292_3.htm")) {
            ...
            int reflectId = player.getPositionComponent().getReflectionId();
        ...
        switch (npcId) {
            ...
            case ELCARDIA:
                if (cond == 2)
                    ...
                    st.doTakeItems(ELCARDIAS_MARK, -1);
                    st.playSound(SOUND_MIDDLE);
                    st.setCond(5);
                } else if (cond == 5)
                    ...
                    st.addExpAndSp(ConfigQuests.SEVEN_SIGN_QUEST_RATE * 10000000, ConfigQuests.SEVEN_SIGN_QUEST_RATE * 1000000);
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        ...
        if (cond == 3 && ArrayUtils.contains(MOBS_1, npcId) && Rnd.chance(70)) {
            st.doGiveItems(ELCARDIAS_MARK, 1);
