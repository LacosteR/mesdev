...
public class _10286_ReunionWithSirra extends Quest implements ScriptFile {
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("rafforty_q10286_02.htm")) {
            ...
            st.setCond(3);
            NpcInstance sirra = st.getPlayer().getPositionComponent().getReflection().addSpawnWithoutRespawn(Sirra, new Location(-23848, -8744, -5413, 49152), 0);
