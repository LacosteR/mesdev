    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("elcardia_q10294_4.htm")) {
            ...
            if (st.getInt("green") == 0) {
                npc.setNpcState(1);
                st.set("green", 1);
                st.getPlayer().getPositionComponent().getReflection().addSpawnWithoutRespawn(JudevanEtinasEvilThoughts, new Location(87704, -249496, -8320, 49152), 0);
                for (int i = 0; i < 3; i++)
                    st.getPlayer().getPositionComponent().getReflection().addSpawnWithoutRespawn(SolinaLayrother, Location.findPointToStay(st.getPlayer(), 300), 0);
                proccessComplete(st);
            } else
                htmltext = "readingdesk_q10294_0.htm";
            ...
            if (st.getInt("blue") == 0) {
                npc.setNpcState(1);
                st.set("blue", 1);
                st.getPlayer().getPositionComponent().getReflection().addSpawnWithoutRespawn(SolinasEvilThoughts, new Location(86680, -246728, -8320, 0), 0);
                proccessComplete(st);
            } else
                htmltext = "readingdesk_q10294_0.htm";
            ...
            if (st.getInt("red") == 0) {
                npc.setNpcState(1);
                st.set("red", 1);
                st.getPlayer().getPositionComponent().getReflection().addSpawnWithoutRespawn(JudevanEtinasEvilThoughts2, new Location(84840, -252392, -8320, 49152), 0);
                proccessComplete(st);
            } else
                htmltext = "readingdesk_q10294_0.htm";
            ...
            st.addExpAndSp(ConfigQuests.SEVEN_SIGN_QUEST_RATE * 25000000, ConfigQuests.SEVEN_SIGN_QUEST_RATE * 2500000);
