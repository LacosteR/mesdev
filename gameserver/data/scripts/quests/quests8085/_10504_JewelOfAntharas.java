...
public class _10504_JewelOfAntharas extends Quest implements ScriptFile {
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("antharas_watchman_theodric_q10504_04.htm")) {
            ...
            st.doGiveItems(CLEAR_CRYSTAL, 1);
        }
        return htmltext;
    }
        ...
        if (npcId == THEODRIC) {
            if (cond == 0) {
                ...
                if (st.getQuestItemsCount(FILLED_CRYSTAL_ANTHARAS) >= 1) {
                    ...
                    st.doTakeItems(FILLED_CRYSTAL_ANTHARAS);
                    st.doGiveItems(JEWEL_OF_ANTHARAS, 1);
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        ...
        if (cond == 1 && npcId == ULTIMATE_ANTHARAS) {
            st.doTakeItems(CLEAR_CRYSTAL);
            st.doGiveItems(FILLED_CRYSTAL_ANTHARAS, 1);
            st.setCond(2);
        }
        return null;
    }
