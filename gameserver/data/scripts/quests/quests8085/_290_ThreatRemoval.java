...
public class _290_ThreatRemoval extends Quest implements ScriptFile {
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("pinaps_q290_02.htm")) {
            ...
            st.doTakeItems(SelMahumIDTag, 400);
            switch (Rnd.get(1, 6)) {
                case 1:
                ...
                case 4:
                    ...
                    break;
                case 5:
                    st.doGiveItems(9552, Rnd.get(1, 2));
                    break;
                case 6:
                    st.doGiveItems(9552, Rnd.get(2, 3));
                    break;
            }
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        ...
        if (cond == 1) {
            if (ArrayUtils.contains(SelMahumTrainers, npc.getNpcId()))
                st.doGiveOnKillItems(SelMahumIDTag, 1, 1, 93);
            else if (ArrayUtils.contains(SelMahumRecruits, npc.getNpcId()))
                st.doGiveOnKillItems(SelMahumIDTag, 1, 1, 36);
        }
        return null;
    }
