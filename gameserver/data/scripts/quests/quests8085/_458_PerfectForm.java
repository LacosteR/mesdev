...
public class _458_PerfectForm extends Quest implements ScriptFile {
        ...
        if (event.equalsIgnoreCase("kelleyia_q458_05.htm")) {
            ...
            switch (st.getInt("contoverhits")) {
                ...
                case 3:
                    ...
                    st.doGiveItems(reward[0], RATE_QUESTS_REWARD * reward[1]);
                    st.doGiveItems(15482, 10);
                    st.doGiveItems(15483, 10);
                    break;
            }
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        ...
        if (doneCond) {
            st.set("normaloverhits", RATE_QUESTS_DROP * Rnd.get(1, 3));
            st.set("critoverhits", RATE_QUESTS_DROP * Rnd.get(1, 3));
            st.set("contoverhits", RATE_QUESTS_DROP * Rnd.get(1, 3));
            st.setCond(2);
        }
        return null;
    }
