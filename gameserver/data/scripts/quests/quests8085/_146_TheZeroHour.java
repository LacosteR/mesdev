...
import quests.quests6076._109_InSearchOfTheNest;
...
public class _146_TheZeroHour extends Quest implements ScriptFile {
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equals("reward") && cond == 2) {
            ...
            st.doTakeItems(STAKATO_QUEENS_FANG, -1);
            st.doGiveItems(KAHMANS_SUPPLY_BOX, 1);
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        if (st.getState() == STARTED) {
            st.setCond(2);
            st.doGiveItems(STAKATO_QUEENS_FANG, 1);
        }
        return null;
    }
}