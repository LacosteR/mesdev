...
public class _308_ReedFieldMaintenance extends Quest implements ScriptFile {
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == Katensa)
            if (id == CREATED) {
                ...
                st.doTakeItems(AwakenMucrokianHide, -1);
                if (awaken > 0)
                    st.doGiveItems(MucrokianHide, awaken * 2);
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        st.doGiveOnKillItems(npc.getNpcId() == ChangedMucrokian ? AwakenMucrokianHide : MucrokianHide, 1, 1, 60);
        return null;
    }
}