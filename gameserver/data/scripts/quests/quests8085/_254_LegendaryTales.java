...
public class _254_LegendaryTales extends Quest implements ScriptFile {
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("gilmore_q254_05.htm")) {
            ...
            st.doTakeItems(LargeBone, -1);
            StringTokenizer tokenizer = new StringTokenizer(event);
            tokenizer.nextToken();
            switch (Integer.parseInt(tokenizer.nextToken())) {
                case 1:
                    st.doGiveItems(13467, 1);
                    break;
                case 2:
                    st.doGiveItems(13462, 1);
                    break;
                case 3:
                    st.doGiveItems(13464, 1);
                    break;
                case 4:
                    st.doGiveItems(13461, 1);
                    break;
                case 5:
                    st.doGiveItems(13465, 1);
                    break;
                case 6:
                    st.doGiveItems(13463, 1);
                    break;
                case 7:
                    st.doGiveItems(13460, 1);
                    break;
                case 8:
                    st.doGiveItems(13466, 1);
                    break;
                case 9:
                    st.doGiveItems(13459, 1);
                    break;
                case 10:
                    st.doGiveItems(13457, 1);
                    break;
                case 11:
                    st.doGiveItems(13458, 1);
                    break;
                default:
                    break;
            }
