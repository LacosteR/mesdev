        ...
        if (event.equals("quest_accept")) {
            ...
            if (st.getCond() == 2)
                if (st.getQuestItemsCount(THIEF_KEY) < 1)
                    ...
                    st.doTakeItems(THIEF_KEY, 1);
                } else {
                    st.doTakeItems(THIEF_KEY, 1);
                    st.doGiveItems(STOLEN_GREEN_TOTEM, 1);
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == WAHKAN) {
            ...
            if (cond == 1) {
                ...
                st.doTakeItems(STOLEN_GREEN_TOTEM, st.getQuestItemsCount(STOLEN_GREEN_TOTEM));
                st.doGiveItems(GREEN_TOTEM, 1);
                st.doGiveItems(DIVINE_STONE_OF_WISDOM, 1);
