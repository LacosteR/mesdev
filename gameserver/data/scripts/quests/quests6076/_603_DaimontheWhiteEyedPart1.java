...
public class _603_DaimontheWhiteEyedPart1 extends Quest implements ScriptFile {
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("31683-02.htm")) {
            ...
            st.doGiveItems(BROKEN_CRYSTAL, 1);
            ...
            if (st.getQuestItemsCount(BROKEN_CRYSTAL) < 5)
                ...
                st.setCond(7);
                st.setState(STARTED);
                st.doTakeItems(BROKEN_CRYSTAL, -1);
                st.playSound("ItemSound.quest_middle");
            }
            ...
            if (st.getQuestItemsCount(EVIL_SPIRIT) < 200)
                ...
                st.doTakeItems(EVIL_SPIRIT, -1);
                st.doGiveItems(U_SUMMON, 1);
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        if (st.doGiveOnKillItems(EVIL_SPIRIT, 1, 1, 200, 100))
            st.setCond(8);
