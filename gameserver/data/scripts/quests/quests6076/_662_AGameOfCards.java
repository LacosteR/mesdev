...
public class _662_AGameOfCards extends Quest implements ScriptFile {
    ...
    public String onKill(NpcInstance npc, QuestState qs) {
        if (qs.getState() == STARTED)
            qs.doGiveOnKillItems(RED_GEM, 1, 1, drop_chance);
        return null;
    }
        ...
        private String finish(QuestState st) {
            ...
            if (cmatches.length == 1) {
                if (cmatches[0] == 5) {
                    ...
                    st.doGiveItems(ZIGGOS_GEMSTONE, 43);
                    st.doGiveItems(Enchant_Weapon_S, 3);
                    st.doGiveItems(Enchant_Weapon_A, 1);
                    ...
                    st.doGiveItems(Enchant_Weapon_S, 2);
                    st.doGiveItems(Enchant_Weapon_C, 2);
                    ...
                    st.doGiveItems(Enchant_Armor_D, 2);
                }
                ...
                if (cmatches[0] == 3 || cmatches[1] == 3) {
                    ...
                    st.doGiveItems(Enchant_Weapon_A, 1);
                    st.doGiveItems(Enchant_Weapon_B, 2);
                    st.doGiveItems(Enchant_Weapon_D, 1);
                } else {
                    txt = "Hmmm...? This is... Two pairs? You got lucky this time, but I wonder if it'll last. Here's your prize.";
                    st.doGiveItems(Enchant_Weapon_C, 1);
                }
