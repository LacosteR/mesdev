...
public class _619_RelicsOfTheOldEmpire extends Quest implements ScriptFile {
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        if (event.equals("explorer_ghost_a_q0619_03.htm")) {
            ...
            st.doTakeItems(Broken_Relic_Part, 1000);
            st.doGiveItems(Recipes[Rnd.get(Recipes.length)], 1);
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        ...
        st.doGiveOnKillItems(Broken_Relic_Part, 1, 1, Broken_Relic_Part_chance);
        if (npcId > 20000)
            st.doGiveOnKillItems(Entrance_Pass_to_the_Sepulcher, 1, 1, 3);
        return null;
    }
