    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("accept")) {
            ...
            if (!st.checkQuestItemsCount(GOBLETS))
                return "31453-14.htm";
            st.doTakeItems(GOBLETS);
            st.doGiveItems(ANTIQUE_BROOCH, 1);
            st.setCond(2);
