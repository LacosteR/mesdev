    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == Marquez) {
            ...
            if (cond == 3)
                ...
                st.doTakeItems(Mushika_egg, 1);
                st.addExpAndSp(RATE_QUESTS_REWARD * 301922, RATE_QUESTS_REWARD * 30294);
                st.doRewardItems(ADENA_ID, 100013);
