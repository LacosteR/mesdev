...
public class _031_SecretBuriedInTheSwamp extends Quest implements ScriptFile {
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equals("31555-1.htm")) {
            ...
            st.doGiveItems(KRORINS_JOURNAL, 1);
            ...
            st.doTakeItems(KRORINS_JOURNAL, -1);
            st.addExpAndSp(RATE_QUESTS_REWARD * 490000, RATE_QUESTS_REWARD * 45880);
            st.doRewardItems(ADENA_ID, 120000);
