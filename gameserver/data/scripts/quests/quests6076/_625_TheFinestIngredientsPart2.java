...
public class _625_TheFinestIngredientsPart2 extends Quest implements ScriptFile {
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("jeremy_q0625_0104.htm") && _state == CREATED) {
            ...
            st.setState(STARTED);
            st.setCond(1);
            st.doTakeItems(Soy_Sauce_Jar, 1);
            st.doGiveItems(Food_for_Bumbalump, 1);
            ...
            st.doTakeItems(Special_Yeti_Meat, 1);
            st.doGiveItems(Rnd.get(Reward_First, Reward_Last), 5);
            ...
            st.doTakeItems(Food_for_Bumbalump, 1);
            st.setCond(2);
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        ...
        if (st.getCond() == 1 || st.getCond() == 2) {
            if (st.getQuestItemsCount(Food_for_Bumbalump) > 0)
                st.doTakeItems(Food_for_Bumbalump, 1);
            st.doGiveItems(Special_Yeti_Meat, 1);
            st.setCond(3);
