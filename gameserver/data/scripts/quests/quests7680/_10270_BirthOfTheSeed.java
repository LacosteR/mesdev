...
public class _10270_BirthOfTheSeed extends Quest implements ScriptFile {
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equals("take") && cond == 0) {
            ...
            st.doTakeItems(Yehan_Klodekus_Badge, -1);
            st.doTakeItems(Yehan_Klanikus_Badge, -1);
            st.doTakeItems(Lich_Crystal, -1);
            ...
            st.doRewardItems(ADENA_ID, 41677);
            st.addExpAndSp(RATE_QUESTS_REWARD * 251602, RATE_QUESTS_REWARD * 25244);
