...
public class _691_MatrasSuspiciousRequest extends Quest implements ScriptFile {
    ...
    public String onEvent(String event, QuestState qs, NpcInstance npc) {
        if (event.equalsIgnoreCase("32245-03.htm")) {
            ...
            qs.doTakeItems(RED_STONE, RED_STONES_COUNT);
            qs.doGiveItems(DYNASTIC_ESSENCE_II, RATE_QUESTS_REWARD * 1);
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        st.doGiveOnKillItems(RED_STONE, 1, 1, RED_STONES_COUNT, npc.getNpcId() == LABYRINTH_CAPTAIN ? 50 : 30);
        return null;
    }
}