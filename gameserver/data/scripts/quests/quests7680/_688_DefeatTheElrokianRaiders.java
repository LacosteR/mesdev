...
public class _688_DefeatTheElrokianRaiders extends Quest implements ScriptFile {
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("32105-03.htm")) {
            ...
            if (count > 0) {
                st.doTakeItems(DINOSAUR_FANG_NECKLACE, -1);
                st.doRewardItems(ADENA_ID, count * 3000);
            }
            ...
            if (count >= 100) {
                st.doTakeItems(DINOSAUR_FANG_NECKLACE, 100);
                st.doRewardItems(ADENA_ID, 450000);
            } else
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        ...
        st.doGiveOnKillItems(DINOSAUR_FANG_NECKLACE, 1, 1, 100, DROP_CHANCE);
