...
public class _194_SevenSignsMammonsContract extends Quest implements ScriptFile {
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("sirgustavathebaldt_q194_2.htm")) {
            ...
            st.setCond(3);
            st.playSound(SOUND_MIDDLE);
            st.doGiveItems(AthebaldtsIntroduction, 1);
        } else if (event.equalsIgnoreCase("colin_q194_3.htm")) {
            st.doTakeItems(AthebaldtsIntroduction, -1);
            st.setCond(4);
            ...
            st.setCond(5);
            st.playSound(SOUND_MIDDLE);
            st.doGiveItems(FrogKingsBead, 1);
        } else if (event.equalsIgnoreCase("colin_q194_5.htm")) {
            st.setCond(6);
            st.doTakeItems(FrogKingsBead, -1);
            st.playSound(SOUND_MIDDLE);
            ...
            st.setCond(8);
            st.doGiveItems(GrandmaTessCandyPouch, 1);
            st.playSound(SOUND_MIDDLE);
        } else if (event.equalsIgnoreCase("colin_q194_8.htm")) {
            st.setCond(9);
            st.doTakeItems(GrandmaTessCandyPouch, -1);
            st.playSound(SOUND_MIDDLE);
            ...
            st.setCond(11);
            st.doGiveItems(NativesGlove, 1);
            st.playSound(SOUND_MIDDLE);
        } else if (event.equalsIgnoreCase("colin_q194_10a.htm")) {
            st.setCond(12);
            st.doTakeItems(NativesGlove, -1);
            st.playSound(SOUND_MIDDLE);
