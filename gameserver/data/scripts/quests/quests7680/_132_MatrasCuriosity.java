    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("32245-02.htm")) {
            ...
            if (is_given != null)
                ...
                int item_reward_count = Rnd.get(1, RATE_QUESTS_REWARD);
                st.doGiveItems(Rough_Ore_of_Fire, item_reward_count);
                st.doGiveItems(Rough_Ore_of_Water, item_reward_count);
                st.doGiveItems(Rough_Ore_of_Earth, item_reward_count);
                st.doGiveItems(Rough_Ore_of_Wind, item_reward_count);
                st.doGiveItems(Rough_Ore_of_Darkness, item_reward_count);
                st.doGiveItems(Rough_Ore_of_Divinity, item_reward_count);
            ...
            st.doGiveItems(ADENA_ID, RATE_QUESTS_REWARD * 31210);
