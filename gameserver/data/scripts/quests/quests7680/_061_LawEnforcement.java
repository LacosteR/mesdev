...
public class _061_LawEnforcement extends Quest implements ScriptFile {
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equals("ask")) {
            ...
            } else if (st.getPlayer().getPcClass() != PcClass.inspector || st.getPlayer().getLevel() < 76) {
            ...
            st.doRewardItems(ADENA_ID, 26000);
            st.getPlayer().setClassId(PcClass.judicator.ordinal(), false, true);
