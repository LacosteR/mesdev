...
public class _198_SevenSignsEmbryo extends Quest implements ScriptFile {
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("wood_q198_2.htm")) {
            ...
            NpcInstance embryo = player.getPositionComponent().getReflection().addSpawnWithoutRespawn(ShilensEvilThoughtsCapt, setcloc, 0);
            st.set("embryo", 1);
        ...
        if (npcId == Wood) {
            ...
            if (cond == 0) {
                ...
                if (player.getBaseClassId() == player.getActiveClassId()) {
                    st.addExpAndSp(ConfigQuests.SEVEN_SIGN_QUEST_RATE * 315108090, ConfigQuests.SEVEN_SIGN_QUEST_RATE * 34906059);
                    st.doGiveItems(DawnsBracelet, 1);
                    st.doRewardItems(AncientAdena, 1500000);
