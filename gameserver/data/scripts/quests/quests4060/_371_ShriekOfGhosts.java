...
public class _371_ShriekOfGhosts extends Quest implements ScriptFile {
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("30867-03.htm") && _state == CREATED) {
            ...
            if (Ancient_Ash_Urn_count > 0) {
                st.doTakeItems(Ancient_Ash_Urn, -1);
                st.doGiveItems(ADENA_ID, Ancient_Ash_Urn_count * 1000L);
            }
            ...
            if (Ancient_Ash_Urn_count > 0) {
                ...
                st.doTakeItems(Ancient_Ash_Urn, -1);
                st.doGiveItems(ADENA_ID, bonus + Ancient_Ash_Urn_count * 1000L);
            } else
    ...
    public String onKill(NpcInstance npc, QuestState qs) {
        ...
        if (Rnd.chance(_chance)) {
            st.doGiveItems(Rnd.chance(Urn_Chance) ? Ancient_Ash_Urn : Ancient_Porcelain, 1);
