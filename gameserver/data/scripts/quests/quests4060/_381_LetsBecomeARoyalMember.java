    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == SORINT) {
            if (cond == 0)
                ...
                if (coin > 0 && album > 0) {
                    st.doTakeItems(KAILS_COIN, -1);
                    st.doTakeItems(COIN_ALBUM, -1);
                    st.doGiveItems(ROYAL_MEMBERSHIP, 1);
            ...
            if (album > 0)
                ...
                st.doTakeItems(CLOVER_COIN, -1);
                st.doGiveItems(COIN_ALBUM, 1);
