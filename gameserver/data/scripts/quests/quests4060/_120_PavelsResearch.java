...
import quests.quests6076._114_ResurrectionOfAnOldManager;
...
public class _120_PavelsResearch extends Quest implements ScriptFile {
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("32041-03.htm")) {
            ...
            st.setCond(16);
            st.doGiveItems(Enigma, 1);
            st.playSound("ItemSound.quest_middle");
        } else if (event.equalsIgnoreCase("32041-22.htm")) {
            st.setCond(17);
            st.doTakeItems(Enigma, 1);
            st.playSound("ItemSound.quest_middle");
        } else if (event.equalsIgnoreCase("32041-32.htm")) {

            st.doTakeItems(Necklace, 1);
            st.doGiveItems(EarPhoenix, 1);
            st.doRewardItems(ADENA_ID, 783729);
            st.addExpAndSp(RATE_QUESTS_REWARD * 3447315, RATE_QUESTS_REWARD * 272615);
            ...
            st.setCond(24);
            st.playSound("ItemSound.quest_middle");
            st.doTakeItems(Heart, 1);
        } else if (event.equalsIgnoreCase("32047-32.htm")) {
            st.setCond(25);
            st.playSound("ItemSound.quest_middle");
            st.doGiveItems(Necklace, 1);
