...
public class _366_SilverHairedShaman extends Quest implements ScriptFile {
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("30111-02.htm")) {
            ...
            st.doTakeItems(SAIRONS_SILVER_HAIR, -1);
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == 30111)
            if (cond == 0) {
                ...
                st.doGiveItems(ADENA_ID, ((st.getQuestItemsCount(SAIRONS_SILVER_HAIR) * ADENA_PER_ONE) + START_ADENA));
                st.doTakeItems(SAIRONS_SILVER_HAIR, -1);
    ...
    public String onKill(NpcInstance npc, QuestState st) {
        ...
        if (cond == 1 && Rnd.chance(66)) {
            st.doGiveItems(SAIRONS_SILVER_HAIR, 1);
