...
public class _186_ContractExecution extends Quest implements ScriptFile {
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("researcher_lorain_q0186_03.htm")) {
            ...
            st.setCond(1);
            st.doTakeItems(Certificate, -1);
            st.doGiveItems(MetalReport, 1);
            ...
            st.doRewardItems(ADENA_ID, 105083);
            st.addExpAndSp(RATE_QUESTS_REWARD * 285935, RATE_QUESTS_REWARD * 18711);
