    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == Rafforty && _state == STARTED) {
            if (cond == 1)
                ...
                st.setCond(6);
                st.doGiveItems(Raffortys_Letter, 1);
                st.playSound(SOUND_MIDDLE);
                return "32020-13.htm";
            } else if (cond == 6)
                return "32020-14.htm";
                ...
                st.doGiveItems(ADENA_ID, RATE_QUESTS_REWARD * 115673);
                st.addExpAndSp(RATE_QUESTS_REWARD * 493595, RATE_QUESTS_REWARD * 40442);
                st.playSound(SOUND_FINISH);
                st.exitCurrentQuest(false);
                return "32020-18.htm";
            }
