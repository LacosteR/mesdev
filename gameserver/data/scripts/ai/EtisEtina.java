...
public class EtisEtina extends Fighter {
    ...
    protected void onEvtAttacked(Creature attacker, int damage, Skill skill) {
        ...
        if (actor.getCurrentHpPercents() < 70 && !summonsReleased) {
            ...
            summon1 = NpcUtils.spawnSingle(18950, Location.findAroundPosition(actor, 150), actor.getPositionComponent().getReflection());
            summon2 = NpcUtils.spawnSingle(18951, Location.findAroundPosition(actor, 150), actor.getPositionComponent().getReflection());
        }
