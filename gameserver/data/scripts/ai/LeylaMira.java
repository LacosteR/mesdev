...
public class LeylaMira extends DefaultAI {
    ...
    protected void onEvtSpawn() {
        ...
        addMoveToDesire(new Location(-56657, -56338, -2006), true, 5);
        doTask();
    ...
    private class ScheduleStart implements Runnable {
        ...
        public void run() {
            switch (_taskId) {
                case 1:
                    _actor.broadcastPacket(new PlaySound(PlaySound.Type.MUSIC, "NS22_F", 1, 0, _actor.getPositionComponent().getLoc()));
    ...
    private class ScheduleMoveFinish implements Runnable {
        @Override
        public void run() {
            addMoveToDesire(new Location(-56594, -56064, -1988), true, 5);
            doTask();
        }
    }
}