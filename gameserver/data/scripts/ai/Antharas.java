...
public class Antharas extends DefaultAI {
    ...
    protected boolean createNewTask() {
        ...
        if (_minionsSpawnDelay < System.currentTimeMillis() && getAliveMinionsCount() < 30 && Rnd.chance(5)) {
            NpcInstance minion = Functions.spawn(Location.findPointToStay(actor.getPositionComponent().getLoc(), 400, 700, actor.getPositionComponent().getGeoIndex()), Rnd.chance(50) ? 29190 : 29069);  // Antharas Minions
            minions.add(minion);
