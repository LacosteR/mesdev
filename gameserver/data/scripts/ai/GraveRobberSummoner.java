...
public class GraveRobberSummoner extends Mystic {
    ...
    protected void onEvtSpawn() {
        ...
        Privates pvt = new Privates();
        pvt.setNpcName(NpcDataHolder.getInstance().getNpcNameById(Servitors[Rnd.get(Servitors.length)]));
        pvt.setCount(Rnd.get(2));
        actor.getMinionList().addMinion(pvt);
