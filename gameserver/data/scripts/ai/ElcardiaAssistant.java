...
import quests.quests8085._10293_SevenSignsForbiddenBook;
import quests.quests8085._10294_SevenSignsMonasteryofSilence;
import quests.quests8085._10295_SevenSignsSolinasTomb;
import quests.quests8085._10296_SevenSignsPoweroftheSeal;
...
public class ElcardiaAssistant extends DefaultAI {
    ...
    private Player getMaster() {
        if (!getActor().getPositionComponent().getReflection().getPlayers().isEmpty())
            return getActor().getPositionComponent().getReflection().getPlayers().get(0);
        return null;
    }
    ...
    protected boolean thinkActive() {
        ...
        if (following == null || !actor.isFollow) {
            ...
            if (master != null) {
                ...
                actor.setRunning();
                actor.getAI().setIntention(CtrlIntention.AI_INTENTION_FOLLOW, master, ConfigOthers.FOLLOW_RANGE);
            }
        }
        super.thinkActive();
        return false;
    ...
    protected void thinkFollow() {
        ...
        // -----------------
        Reflection ref = actor.getPositionComponent().getReflection();
    ...
    protected class ThinkFollow extends RunnableImpl {
        ...
        public void runImpl() {
            ...
            if (target == null || PositionUtils.getDistance(actor, target) > 4000) {
