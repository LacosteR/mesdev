...
public class Kanabion extends Fighter {
    ...
    public static class SpawnNext extends RunnableImpl {
        ...
        public void runImpl() throws Exception {
            ...
            sp.setLocx(_actor.getPositionComponent().getX());
            sp.setLocy(_actor.getPositionComponent().getY());
            sp.setLocz(_actor.getPositionComponent().getZ());
            sp.setReflection(_actor.getPositionComponent().getReflection());
