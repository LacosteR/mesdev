...
import quests.questsclan._732_ProtectTheReligiousAssociationLeader;
    ...
    public void onEvtDead(Creature killer) {
        ...
        if (player.getParty() == null) {
            ...
            for (Player $member : player.getParty()) {
                if (PositionUtils.isInRange($member, player, ConfigOthers.PARTY_DISTRIBUTION_RANGE, false)) {
