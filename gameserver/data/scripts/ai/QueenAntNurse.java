...
public class QueenAntNurse extends Priest {
    ...
    protected boolean thinkActive() {
        ...
        if (PositionUtils.getDistance(actor, top_desire_target) - top_desire_target.getColRadius() - actor.getColRadius() > 200) {
    ...
    protected boolean createNewTask() {
        ...
        if (!top_desire_target.isCurrentHpFull()) {
            ...
            if (skill.getAOECastRange() < PositionUtils.getDistance(actor, top_desire_target))
            ...
            addUseSkillDesire(top_desire_target, skill, 10000);
            return true;
        }
