...
public class SoulCoffin extends DefaultAI {
    ...
    protected boolean thinkActive() {
        NpcInstance actor = getActor();
        if (actor.getNpcId() == 18706 && actor.getPositionComponent().getReflection().getInstancedZoneId() == 116 && checkTimer + 10000 < System.currentTimeMillis()) {
            checkTimer = System.currentTimeMillis();
            ((SufferingHallDefence) actor.getPositionComponent().getReflection()).notifyCoffinActivity();
        }
