    ...
    public void onBypassFeedback(Player player, String command) {
        ...
        if (command.equalsIgnoreCase("guardInfo")) {
            ...
            if (fortress.getSupplySpawn() + 3600000 < System.currentTimeMillis()) {
                ...
                fortress.update();
                NpcInstance npc = NpcFactory.createNpc(SUPPLY_NPC[fortress.getSupplyCount() - 1]);
                npc.setCurrentHpMp(npc.getMaxHp(), npc.getMaxMp());
                npc.spawnMe(new Location(getPositionComponent().getX() - 23, getPositionComponent().getY() + 41, getPositionComponent().getZ()));
            } else
