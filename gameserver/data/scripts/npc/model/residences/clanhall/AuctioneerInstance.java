...
public class AuctioneerInstance extends NpcInstance {
    ...
    public void onBypassFeedback(Player player, String command) {
        ...
        //=============================================================================================
            ...
            msg.replace("%clan_adena%", String.valueOf(player.getClan().getWarehouse().getCountOf(ConfigExternal.CLANHALL_AUCTION_ITEM_ID)));
        ...
        //=============================================================================================
            ...
            player.getClan().getWarehouse().destroyItemByItemId(ConfigExternal.CLANHALL_AUCTION_ITEM_ID, consumeBid);
        ...
        //=============================================================================================
            ...
            player.getClan().getWarehouse().addItem(ConfigExternal.CLANHALL_AUCTION_ITEM_ID, returnVal);
        ...
        //=============================================================================================
            ...
            msg.replace("%adena%", String.valueOf(player.getClan().getWarehouse().getCountOf(ConfigExternal.CLANHALL_AUCTION_ITEM_ID)));
        ...
        //=============================================================================================
            ...
            if (player.getClan().getWarehouse().getCountOf(ConfigExternal.CLANHALL_AUCTION_ITEM_ID) < clanHall.getDeposit()) {
        ...
        //=============================================================================================
            ...
            for (AuctionSiegeClanObject $siegeClan : siegeClans) {
                ...
                $siegeClan.getClan().getWarehouse().addItem(ConfigExternal.CLANHALL_AUCTION_ITEM_ID, returnBid);
            }
    ...
    private boolean checkBid(Player player, ClanHallAuctionEvent auctionEvent, final long bid) {
        ...
        if (consumeBid > player.getClan().getWarehouse().getCountOf(ConfigExternal.CLANHALL_AUCTION_ITEM_ID)) {
            player.sendPacket(SystemMsg.THERE_IS_NOT_ENOUGH_ADENA_IN_THE_CLAN_HALL_WAREHOUSE);
            onBypassFeedback(player, "bid_start " + auctionEvent.getId());
            return false;
        }
