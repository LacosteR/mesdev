    ...
    public void onBypassFeedback(Player player, String command) {
        ...
        } else if (command.startsWith("infinitum_entrance")) // Jerian
        {
            ...
            for (Player member : members)
                if (member == null || !PositionUtils.isInRange(this, member, 500, false) || member.getEffectList().getEffectsBySkillId(FieryDemonBloodSkill) == null) {
                    showDialog(player, getHtmlPath(getNpcId(), 2, player));
                    return;
                }
        ...
        } else if (command.startsWith("tully_dorian_entrance")) // Dorian
        {
            ...
            for (Player member : members)
                if (member == null || !PositionUtils.isInRange(this, member, 500, false) || !member.isQuestCompleted("_132_MatrasCuriosity")) {
                    showDialog(player, getHtmlPath(getNpcId(), 1, player));
                    return;
                }
