...
public final class MaguenTraderInstance extends NpcInstance {
    ...
    public void onBypassFeedback(Player player, String command) {
        ...
        if (command.equalsIgnoreCase("request_collector")) {
            ...
            NpcUtils.spawnSingle(18839, Location.findPointToStay(getSpawnedLoc(), 40, 100, getPositionComponent().getGeoIndex()), getPositionComponent().getReflection()); // wild maguen
