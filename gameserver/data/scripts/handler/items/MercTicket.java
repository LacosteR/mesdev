...
public class MercTicket extends ScriptItemHandler {
    ...
    public void dropItem(Player player, ItemInstance item, long count, Location loc) {
        ...
        for (ItemInstance $item : castle.getSpawnMerchantTickets()) {
            if (PositionUtils.getDistance($item.getPositionComponent().getLoc(), loc) < 200) {
        ...
        CastleHiredGuardDAO.getInstance().insert(castle, item.getItemId(), item.getPositionComponent().getLoc());
    }
