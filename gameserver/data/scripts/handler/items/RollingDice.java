...
public class RollingDice extends ScriptItemHandler {
    ...
    public boolean useItem(Playable playable, ItemInstance item, boolean ctrl) {
        ...
        player.broadcastPacket(new Dice(player.getObjectId(), itemId, number, player.getPositionComponent().getX() - 30, player.getPositionComponent().getY() - 30, player.getPositionComponent().getZ()), new SystemMessage(SystemMessage.S1_HAS_ROLLED_S2).addString(player.getName()).addNumber(number));
