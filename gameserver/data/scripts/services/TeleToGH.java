...
public class TeleToGH extends Functions implements ScriptFile {
    ...
    @Override
    public void onLoad() {
        if (!ConfigServices.SERVICES_GIRAN_HARBOR_ENABLED)
            return;
    ...
    public String getHtmlAppends(Integer val) {
        if (val != 0 || !ConfigServices.SERVICES_GIRAN_HARBOR_ENABLED)
            return "";
        Player player = getSelf();
        if (player == null)
            return "";
    ...
    public String getHtmlAppends2(Integer val) {
        if (val != 0 || !ConfigServices.SERVICES_GIRAN_HARBOR_ENABLED)
            return "";
        Player player = getSelf();
        if (player == null || player.getPositionComponent().getReflectionId() != -2)
            return "";
    ...
    public class ZoneListener implements OnZoneEnterLeaveListener {
        ...
        public void onZoneLeave(Zone zone, Creature cha) {
            ...
            if (player != null)
                if (ConfigServices.SERVICES_GIRAN_HARBOR_ENABLED && player.getPositionComponent().getReflection() == ReflectionManager.GIRAN_HARBOR && player.isVisible()) {
